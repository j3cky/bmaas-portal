...
@enderror
                ...
                <form class="form-horizontal" action="/sshkey/create" method="POST" id="sshkey" name="sshkey">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-8">
                                <input type="text" id="sshkeyname" name="sshkeyname" class="form-control" placeholder="Enter Key Name" value=" {{ old('sshkeyname') }}"/>
                                </div>
			</div>
                        <div class="form-group row">
                                <label for="tenantname" class="col-sm-4 col-form-label">SSH Key</label>
                                <div class="col-8">
                                <textarea class="form-control" name="sshkeycreate" id="sshkeycreate" rows="5" placeholder="Enter SSH Public Key" style="width: 100%;">{{ old('sshkeycreate') }}</textarea>
                                </div>
                        </div>
            </div>
